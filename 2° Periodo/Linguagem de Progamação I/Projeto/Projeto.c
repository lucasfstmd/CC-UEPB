...
void InserirNaFilaC(FilaCPtr * headPtr, FilaCPtr * tailPtr, char CPF[], int Idade, int Temp, int Exame, char Tipo[], char Hora[]);
...
int interface() {
  ...
  int escolha;
  FilaCPtr headPtr = NULL;
  FilaCPtr tailPtr = NULL;
  printf(
...
int compararFilaPacientes(const void * a,
  const void *b) {
